...
const plans = [
  {
    id: "micro",
    name: "Micro",
    tagline: "For micro enterprises (turnover up to ₹5 Cr)",
    monthlyPrice: null,
    annualPrice: 19999,
    priceLabel: "₹19,999",
    priceSub: "per year, GST inclusive",
    cta: "Get started",
    ctaHref: "/register?plan=micro",
    featured: false,
    features: [
      { label: "AI Readiness Assessment (basic)", included: true },
      { label: "5 marketplace asset downloads/year", included: true },
      ...
      { label: "1 specialist Q&A session (1 hr)", included: true },
  ...
  },
  {
    id: "small",
    name: "Small",
    tagline: "For small enterprises (turnover ₹5–75 Cr)",
    monthlyPrice: null,
    annualPrice: 149999,
    priceLabel: "₹1,49,999",
    priceSub: "per year, GST inclusive",
    cta: "Start growing",
    ctaHref: "/register?plan=small",
    featured: true,
    badge: "Most popular",
    features: [
      ...
      { label: "2 specialist consultations (4 hrs each)", included: true },
  ...
  },
  {
    id: "medium",
    name: "Medium",
    tagline: "For medium enterprises (turnover ₹75 Cr–500 Cr)",
    monthlyPrice: null,
    annualPrice: 999999,
    priceLabel: "₹9,99,999",
    priceSub: "per year, GST inclusive",
    cta: "Talk to us",
    ctaHref: "/contact?plan=medium",
    featured: false,
    features: [
      { label: "Everything in Small plan", included: true },
      ...
      { label: "Custom framework development", included: true },
      { label: "On-site workshops (2 per quarter)", included: true },
...
const featureCategories = [
  {
    name: "Marketplace",
    rows: [
      { label: "Annual asset downloads", starter: "5 assets", growth: "Unlimited (member price)", enterprise: "Unlimited" },
  ...
  },
  {
    ...
    rows: [
      { label: "Specialist consultations", starter: "1 session (1 hr)", growth: "2 sessions (4 hrs each)", enterprise: "Dedicated team" },
      { label: "Customer success", starter: "Email support", growth: "Priority support", enterprise: "Named CSM" },
